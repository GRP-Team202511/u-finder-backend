"""
Router tests for GET /auth/settings/email
"""
import pytest
...
class TestGetEmail:
    ...
    async def test_get_email_success(self, mock_auth, client, mock_db):
        """Authenticated user should get their email back."""
    ...
    @patch("src.routers.auth.get_current_user_id", new_callable=AsyncMock, return_value=1)
    async def test_get_email_user_not_found(self, mock_auth, client, mock_db):
    ...
    async def test_get_email_missing_auth_header(self, client):
